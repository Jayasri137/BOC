...
if (!function_exists('load_img')) {
    ...
    function load_img(array $array,$class='') {
        foreach ($array as $uri) {
            echo "<img class='$class' src='" . base_url($uri) . "' />";
        }
    }
...
if (!function_exists('load_select')) {
    ...
    function load_select($array,$val="") {
 ...
 * 
 * @param array $array
 * @return print Radio links
 */
if (!function_exists('load_radio')) {

    function load_radio($array,$name='',$id='', $class='',$val="") {
       $i=0;
        foreach ($array->result() as $row) {
            $checked="";
            if($val==$row->id)
            ...
            $len=strlen($row->name);
            if($len<25){$lenth=5;}if($len<23){$lenth=4;}if($len<18){$lenth=3;}if($len<14){$lenth=2;}if($len<=10){$lenth=2;}
           echo "<button class='btn btn-default col-md-$lenth col-xs-12 $active $class'><input id='$id' name='$name' $checked value='$row->id' type='radio'>$row->name</button>";
		/*echo '<button class="btn btn-default col-md-2 col-xs-12 active">
                        <input id="preferred_writerusa" name="preferred_writerusa" value="USA" type="radio">UG</button>';
                        */
        }
    }
