...
<!-- Content -->
  ...
  <div class="container-xxl flex-grow-1 container-p-y">	
	<div class="row gy-4">
		  ...
		  <div class="row">
			...
			<div class="col-6">
			  <div class="h-100 position-relative">
				<img src="../../../assets_dash/img/illustrations/illustration-1.png" alt="Ratings" class="position-absolute card-img-position scaleX-n1-rtl bottom-0 w-auto end-0 me-3 me-xl-0 me-xxl-3 pe-1" width="95">
			  </div>
			</div>
		  </div>
		</div>
	  ...
	  <div class="col-xl-3 col-sm-6 mt-5">
		<div class="card">
		  <div class="row">
			...
			<div class="col-6">
			  <div class="h-100 position-relative">
				<img src="../../../assets_dash/img/illustrations/illustration-2.png" alt="Ratings" class="position-absolute card-img-position scaleX-n1-rtl bottom-0 w-auto end-0 me-3 me-xl-0 me-xxl-3 pe-1" width="81">
			  </div>
			</div>
		  </div>
		</div>
				...
				<div class="timeline-event">
				  ...
				  <div class="d-flex">
					<a href="javascript:void(0)" class="me-3">
					  <img src="../../../assets_dash/img/icons/misc/pdf.png" alt="PDF image" width="20" class="me-1">
				...
				<div class="timeline-event">
				  ...
				  <div class="d-flex flex-wrap align-items-center">
					<div class="avatar avatar-xs me-2">
					  <img src="../../../assets_dash/img/avatars/1.png" alt="Avatar" class="rounded-circle" />
					</div>
		  ...
		  <div class="card-body pt-0">
			...
			<div class="bg-label-primary p-2 border rounded my-3">
			  <div class="d-flex px-1">
				<div class="avatar flex-shrink-0 me-3">
				  <div class="avatar-initial bg-label-primary rounded">
					<div>
					  <img src="../../../assets_dash/img/icons/unicons/briefcase.png" alt="paypal">
					</div>
				  </div>
				</div>
			...
			<form id="paymentDetailsForm" onsubmit="return false">
			  ...
			  <div class="d-flex mb-3">
				<div class="me-3">
				  <img src="../../../assets_dash/img/icons/payments/logo-mastercard-small.png" alt="credit card" height="30">
				</div>
			  ...
			  <div class="d-flex mb-3">
				<div class="me-3">
				  <img src="../../../assets_dash/img/icons/payments/logo-credit-card-2.png" alt="credit card" height="30">
				</div>
				<div class="d-flex justify-content-between w-100 flex-wrap gap-2">
				  <div>
					<h6 class="mb-0">Credit Card</h6>
		  ...
		  <div class="card-body">
			<ul class="p-0 m-0">
			  <li class="d-flex mb-4 pb-2">
				<div class="avatar flex-shrink-0 me-3">
				  <img src="../../../assets_dash/img/avatars/4.png" alt="avatar" class="rounded-circle">
				</div>
				<div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
				  <div class="me-2">
			  ...
			  <li class="d-flex mb-4 pb-2">
				<div class="avatar flex-shrink-0 me-3">
				  <img src="../../../assets_dash/img/avatars/8.png" alt="avatar" class="rounded-circle">
				</div>
				<div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
				  <div class="me-2">
			  ...
			  <li class="d-flex mb-4 pb-2">
				<div class="avatar flex-shrink-0 me-3">
				  <img src="../../../assets_dash/img/avatars/5.png" alt="avatar" class="rounded-circle">
				</div>
				<div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
				  <div class="me-2">
			  ...
			  <li class="d-flex mb-4 pb-2">
				<div class="avatar flex-shrink-0 me-3">
				  <img src="../../../assets_dash/img/avatars/3.png" alt="avatar" class="rounded-circle">
				</div>
				<div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
				  <div class="me-2">
			  ...
			  <li class="d-flex mb-4 pb-2">
				<div class="avatar flex-shrink-0 me-3">
				  <img src="../../../assets_dash/img/avatars/2.png" alt="avatar" class="rounded-circle">
				</div>
				<div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
				  <div class="me-2">
	  ...
	  <div class="col-xl-4 col-md-6">
		<div class="card">
		  <img class="card-img-top" src="../../../assets_dash/img/elements/laptop.png" alt="laptop image cap" height="188" style="object-fit: cover;">
		  <div class="card-body">
