...
// Fetch all video testimonials with pagination
$videos = [];
try {
    $countQuery = $pdo->query("SELECT COUNT(*) FROM testimonial_videos");
    ...
    $stmt = $pdo->prepare("SELECT * FROM testimonial_videos ORDER BY id DESC LIMIT :limit OFFSET :offset");
