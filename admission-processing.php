...
$pageTitle = 'Study Abroad Admission Consultants in Coimbatore';
$pageDesc = 'Looking for university admission abroad? Bluestone Overseas provides expert admission counselling, SOP preparation and university shortlisting for students in Coimbatore.';
$pageKeywords = 'Study abroad admission consultants in Coimbatore, University admission for study abroad, SOP preparation, University shortlisting';
...
<main>
  ...
  <!-- Hero Section -->
  <section class="section bg-light" style="padding: 6rem 0 2rem; background-color: #ffffff;">
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 4rem; align-items: center;">
        <div class="animate-on-scroll">
          <h1 style="font-size: 3.5rem; font-weight: 800; margin-bottom: 1.5rem; line-height: 1.1; color: var(--dark);">Get Your Application<br> <span style="color: var(--primary);">Ready</span></h1>
          <p style="color:var(--gray); margin-bottom:2.5rem; line-height:1.7; font-size: 1.1rem;">
        ...
        <div class="animate-on-scroll delay-1">
          <div style="background: var(--accent); padding: 3rem; border-radius: 24px; box-shadow: 0 20px 40px rgba(0,0,0,0.06); border: 1px solid #f1f5f9; position: relative;">
            ...
            <h3 style="margin-bottom: 1.5rem; font-size: 1.75rem; color: white;">Admission Advantage</h3>
