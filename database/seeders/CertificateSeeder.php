    ...
    public function run(): void
    {
        ManageCertificateRepository::query()->updateOrCreate(
            ...
            [
                ...
                'certificate_text' => 'This certificate is proudly presented for successfully completing the {course_name} Course with outstanding dedication and excellence. Your commitment to learning and achievement is truly commendable. Presented by Bluestoene IAS Academy',
