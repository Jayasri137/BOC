...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        SettingRepository::query()->updateOrCreate([
            ...
            'footer_text' => $setting?->footer_text ?? 'Developed by  Graphify Info Tech Pvt Ltd.',
            'footer_contact_number' => $setting?->footer_contact_number ?? '+91 9042895697',
            'footer_support_mail' => $setting?->footer_support_mail ?? 'info@graphifyinfotech.com',
