...
$pageHeroImage = 'assets/images/pte.png';
$hideDefaultHero = true;
require_once 'includes/header.php';
?>

<style>
/* PTE Premium Theme Variables */
:root {
...
/* Base Styles specific to PTE page */
.pte-text-gradient {
  ...
  <section class="country-hero-custom" style="background-image: url('<?= htmlspecialchars($pageHeroImage) ?>');">
    ...
    <div class="container animate-on-scroll" style="position: relative; z-index: 2; text-align: left; color: white; width: 100%;">
      <div style="max-width: 800px;">
        ...
        <h1 style="font-size: clamp(2.5rem, 5vw, 4rem); font-weight: 800; margin-bottom: 1.5rem; line-height: 1.2; text-shadow: 0 10px 30px rgba(0,0,0,0.5);">Crack the PTE Academic in Record Time</h1>
        <p class="country-hero-desc" style="font-size: 1.15rem; opacity: 0.9; line-height: 1.7; text-shadow: 0 4px 15px rgba(0,0,0,0.5); border-left: 4px solid var(--pte-primary); padding-left: 1.5rem;">Fast results, fair scoring, and targeted preparation. In association with Bluestone Language Hub, our highly strategic PTE coaching decodes the AI algorithm to help you rapidly meet visa and university requirements for Australia, New Zealand, and the UK.</p>
        
        <div style="display: flex; gap: 1rem; flex-wrap: wrap; margin-top: 2rem;">
            <a href="consultation.php" class="btn btn--primary btn--lg pulse-btn" style="background: var(--pte-primary); box-shadow: 0 10px 25px rgba(139, 92, 246, 0.4);">Join PTE Batch</a>
    ...
    <div class="container">
       <div class="grid grid--2 align-center gap--4">
           <div class="animate-on-scroll">
               ...
               <?php
               try {
                   $stmtBatch = $pdo->prepare("SELECT * FROM upcoming_batches WHERE course_slug = 'pte' AND is_active = 1 ORDER BY id DESC");
                   $stmtBatch->execute();
                   $batches = $stmtBatch->fetchAll();
                   
                   if (!empty($batches)):
               ?>
               <div class="upcoming-batches-wrapper animate-on-scroll" style="background: var(--pte-gradient); border-radius: 24px; padding: 2.5rem; box-shadow: 0 25px 50px rgba(234, 88, 12, 0.2); margin-top: 1rem;">
           ...
           <div class="animate-on-scroll delay-1" style="background: white; border-radius: 24px; padding: 2.5rem; box-shadow: 0 25px 50px rgba(0,0,0,0.08); border: 1px solid rgba(0,0,0,0.05);">
             ...
             <form id="heroLeadForm" onsubmit="return handleFormSubmit(event)">
               ...
               <input type="hidden" name="destination" value="PTE">
  ...
  <section class="section bg-light">
    <div class="container">
      <div class="text-center animate-on-scroll" style="margin-bottom: 4rem;">
        ...
        <h2 class="section__title">Why Choose <span>Bluestone for PTE?</span></h2>
      ...
      <div class="grid grid--3 gap--2">
        ...
        <div class="pte-wave-feature-card tw-theme-1 animate-on-scroll">
          ...
          <p class="twf-desc">We teach you exactly what the PTE Artificial Intelligence is analyzing—from oral fluency pacing to written discourse structure.</p>
  ...
  <section id="curriculum" class="section" style="padding: 6rem 0;">
    <div class="container">
      <div class="text-center animate-on-scroll" style="margin-bottom: 4rem;">
        ...
        <p class="section__subtitle" style="max-width: 600px; margin: 0 auto;">PTE integrates skills heavily. We decode every single question type.</p>
      </div>
      ...
      <div class="pte-elite-wrapper">
        ...
        <div class="pte-elite-card tec-theme-1 animate-on-scroll">
          <div class="tec-image">
            <img src="assets/images/pte_speaking_writing_3d.png" alt="Speaking & Writing Module">
          </div>
        ...
        <div class="pte-elite-card tec-theme-2 animate-on-scroll">
          <div class="tec-image">
            <img src="assets/images/pte_reading_3d.png" alt="Reading Module">
          </div>
          <div class="tec-content">
        ...
        <div class="pte-elite-card tec-theme-3 animate-on-scroll">
          <div class="tec-image">
            <img src="assets/images/pte_listening_3d.png" alt="Listening Module">
          </div>
          <div class="tec-content">
            <div class="tec-icon-wrap"><i class="fa-solid fa-headphones"></i></div>
            <h3 class="tec-title">Listening Module</h3>
            <ul class="tec-list">
              <li>Perfecting 'Write from Dictation' - the highest scoring task in PTE</li>
    ...
    <div class="container">
      <div class="grid grid--2 gap--4" style="align-items: flex-start;">
        ...
        <div class="audience-left animate-on-scroll" style="position: sticky; top: 120px;">
          <span class="section__tag" style="color: var(--pte-primary); background: rgba(139, 92, 246, 0.1);">Target Audience</span>
          <h2 class="section__title" style="text-align: left; margin-bottom: 1.5rem;">Who is this <span>training for?</span></h2>
          <p class="section__subtitle" style="text-align: left; max-width: 100%; margin-bottom: 3rem;">Whether you are applying for permanent residency down under or enrolling in a UK university, PTE offers a fast, fair, and highly flexible testing option.</p>
          ...
          <div style="position: relative; border-radius: 30px; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.08);">
            ...
            <img src="assets/images/pte_audience_3d.png" alt="Target Audience" style="width: 100%; display: block; position: relative; z-index: 2; transition: transform 0.5s ease;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
          </div>
        </div>
        ...
        <div class="audience-right animate-on-scroll delay-1" style="display: flex; flex-direction: column; gap: 2rem;">
          ...
          <!-- Card 1 -->
          <div class="pte-split-card" style="background: linear-gradient(135deg, #f5f3ff, #ede9fe); border: 1px solid rgba(139, 92, 246, 0.2); box-shadow: 0 10px 30px rgba(139, 92, 246, 0.05);">
            <div style="width: 60px; height: 60px; border-radius: 16px; background: white; color: var(--pte-primary); display: flex; align-items: center; justify-content: center; font-size: 1.5rem; flex-shrink: 0; box-shadow: 0 5px 15px rgba(139, 92, 246, 0.1);">
            ...
            <div>
              ...
              <p style="color: var(--gray); line-height: 1.6; font-size: 1rem; margin-bottom: 1rem;">Individuals applying for Permanent Residency in Australia and New Zealand where achieving a PTE score of 79+ yields maximum migration points.</p>
              <span style="display: inline-block; padding: 0.4rem 1rem; background: white; color: var(--pte-primary); font-weight: 600; font-size: 0.85rem; border-radius: 50px; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">Immigration Visas</span>
            </div>
          </div>

          <!-- Card 2 -->
          <div class="pte-split-card" style="background: linear-gradient(135deg, #f0f9ff, #e0f2fe); border: 1px solid rgba(14, 165, 233, 0.2); box-shadow: 0 10px 30px rgba(14, 165, 233, 0.05);">
            ...
            <div>
              ...
              <p style="color: var(--gray); line-height: 1.6; font-size: 1rem; margin-bottom: 1rem;">Nursing professionals pursuing registration with AHPRA in Australia or the NMC in the UK, as PTE offers a highly objective, unbiased scoring system.</p>
          ...
          <!-- Card 3 -->
          <div class="pte-split-card" style="background: linear-gradient(135deg, #f0fdf4, #dcfce7); border: 1px solid rgba(16, 185, 129, 0.2); box-shadow: 0 10px 30px rgba(16, 185, 129, 0.05);">
            ...
            <div>
              ...
              <p style="color: var(--gray); line-height: 1.6; font-size: 1rem; margin-bottom: 1rem;">Students requiring fast turnaround times for university admissions in the UK, USA, and Canada, thanks to PTE's typical 48-hour result delivery.</p>
  ...
  <section class="section" style="padding-top: 2rem;">
    <div class="container animate-on-scroll">
      <div style="background: var(--pte-gradient); padding: 4rem 2rem; border-radius: 30px; text-align: center; color: white; box-shadow: 0 20px 40px rgba(139, 92, 246, 0.2);">
        <h2 style="font-size: 2.5rem; margin-bottom: 1rem; font-weight: 800; font-family: 'Plus Jakarta Sans', sans-serif;">Ready to Decode the PTE Algorithm?</h2>
        ...
        <a href="consultation.php" class="btn btn--white btn--lg pulse-btn" style="background: white; color: var(--pte-primary); font-weight: 700;">Book Free Consultation</a>
      </div>
    </div>
  </section>
</main>
