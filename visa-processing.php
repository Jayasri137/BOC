    ...
    <div class="container">
      <div class="grid grid--2 gap--4 align-center">
        <div class="animate-on-scroll">
          <div class="v-icon" style="width:120px; height:120px; font-size:3rem; margin:0"><i class="fa-solid fa-passport"></i></div>
          <h2 class="section__title" style="text-align:left; margin-top:2rem">Hassle-Free <span>Visa Filing</span></h2>
          <p style="color:var(--gray); margin-top:1rem; line-height:1.6;">
            In association with <strong>Bluestone Overseas</strong> and drawing inspiration from global standards set by leaders like <strong>IDP.com</strong>, we provide end-to-end visa assistance to turn your dreams into reality without the stress.
          </p>
        </div>
        <div class="animate-on-scroll delay-1">
          <div class="service-details grid grid--1 gap--1">
            <div class="a-feat"><i class="fa-solid fa-check-circle"></i><span>Complete Visa Documentation</span></div>
            <div class="a-feat"><i class="fa-solid fa-check-circle"></i><span>Financial Proof Preparation</span></div>
            <div class="a-feat"><i class="fa-solid fa-check-circle"></i><span>1-on-1 Interview Mock Sessions</span></div>
            <div class="a-feat"><i class="fa-solid fa-check-circle"></i><span>Seamless Visa Filing</span></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="grid grid--4 gap--2" style="margin-top: 3rem;">
        <div class="service-card text-center animate-on-scroll">
          ...
          <h3>Pre-screening</h3>
          <p>We review your financial and academic documents to ensure compliance.</p>
        </div>
        <div class="service-card text-center animate-on-scroll delay-1">
          ...
          <h3>Compilation</h3>
          <p>We help you gather, translate, and verify every single required document.</p>
        </div>
        <div class="service-card text-center animate-on-scroll delay-2">
          ...
          <p>Practice with former visa officers to build your confidence.</p>
        </div>
        <div class="service-card text-center animate-on-scroll delay-3">
          ...
          <h3>Submission</h3>
          <p>We submit the application and track the process until approval.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="grid grid--3 gap--2" style="margin-top: 3rem;">
        <div class="service-card animate-on-scroll">
          <h3 style="display: flex; align-items: center; gap: 0.5rem;"><i class="fa-solid fa-trophy text-primary"></i> 98% Success Rate</h3>
          <p>Our meticulous attention to detail has resulted in an industry-leading visa approval rate.</p>
        </div>
        <div class="service-card animate-on-scroll delay-1">
          <h3 style="display: flex; align-items: center; gap: 0.5rem;"><i class="fa-solid fa-user-shield text-primary"></i> Authorized Agents</h3>
          <p>We are officially recognized by various embassies and high commissions globally.</p>
        </div>
        <div class="service-card animate-on-scroll delay-2">
          <h3 style="display: flex; align-items: center; gap: 0.5rem;"><i class="fa-solid fa-clock-rotate-left text-primary"></i> Latest Updates</h3>
          <p>We stay constantly updated with the ever-changing immigration laws and policies.</p>
        </div>
      </div>
    </div>
  </section>
